...
#define BSP_REV     "/12"   /* increment by whole numbers */

#define SHARED_VIDEO_RAM_SIE    0x4000000   /* 共享内存大小 */
#define INCLUDE_DISK_UTIL       /* 增加控制台下文件系统工具 */
#define INCLUDE_SHELL_VI_MODE   /* 增加控制台 */
...
#if 0   /* 1:网络启动 */
#define DEFAULT_BOOT_LINE \
    "gei(0,0)host:vxWorks h=192.168.10.102 e=192.168.10.145:ffffff00 f=0x08 u=target pw=password tn=CD6020SMP o=gei"
#else   /* 0:硬盘启动 */
#define DEFAULT_BOOT_LINE \
    "ata=0,0(0,0)host:/ata0a/vxWorks h=192.168.10.102 e=192.168.10.145:ffffff00 f=0x08 u=target pw=password tn=CD6020SMP o=gei"
#endif
#endif  /* (CPU == I80386) */
...
#define  INCLUDE_DRV_STORAGE_INTEL_ICH  /* vxbus version of ATA disk driver */
#ifdef  INCLUDE_DRV_STORAGE_INTEL_ICH
#   define INCLUDE_DRV_STORAGE_INTEL_ICH_SHOW
#   ifdef BOOTAPP
#      define INCLUDE_BOOT_ICH_LOADER
...
#define ATA0_CONFIG       (ATA_GEO_CURRENT | ATA_BITS_32 | ATA_DMA_AUTO)
...
#define ATA1_CONFIG       (ATA_GEO_CURRENT | ATA_BITS_32 | ATA_DMA_AUTO)
...
#   define SYSTEM_RAM_SIZE      (0x80000000 - SHARED_VIDEO_RAM_SIE)    /* minimum 8MB system RAM */
