...
--------------------
01e,01dec07,mdo  CQ: WIND00110287 - remove obsolete include
01d,19mar07,scm  increase APIC_TIMER_CLOCK_HZ for P4/SMP builds...
01c,26jul06,scm  add PCI-X irq numbers...
...
#   else				      /* P7 */
#       define APIC_TIMER_CLOCK_HZ  200000000 /* base/bus clock: 133/400M */
...
#define INT_NUM_COM3		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_COM4		(INT_NUM_IOAPIC_IRQ5)
...
#define INT_NUM_PCIC		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_TCIC		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_ELT0		(INT_NUM_IOAPIC_IRQ5)
#define INT_NUM_ELT1		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_LPT		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_LPT0		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_LPT1		(INT_NUM_IOAPIC_IRQ5)
#define INT_NUM_LPT2		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_KBD		(INT_NUM_IOAPIC_IRQ1)
#define INT_NUM_MSE		(INT_NUM_IOAPIC_IRQC)
#define INT_NUM_ELC		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_ULTRA		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_EEX		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_ELT		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_ENE		(INT_NUM_IOAPIC_IRQ5)
#define INT_NUM_ESMC		(INT_NUM_IOAPIC_IRQ7)
#define INT_NUM_EI		(INT_NUM_IOAPIC_IRQ7)
